...
\begin{enumerate}
    ...
    \item Gérer les paiements (espèces, chèque, crédit) avec validation EC obligatoire avant remise.
...
\hline
EC & Engagement Client & Gère le référentiel clients, crée et modifie les commandes, gère le stock publié, traite les réclamations, rapproche les encaissements. \\
\hline
...
\begin{itemize}[leftmargin=2.5em]
    ...
    \item[$\bullet$] Gestion des comptes utilisateurs selon les profils définis (AD, PL, MG, CH, EC, CL).
...
\begin{itemize}[leftmargin=2.5em]
    ...
    \item[$\bullet$] Gestion du stock : stock réel (synchronisé WFMS) et stock publié (défini par l'EC, visible par le client).
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\linewidth]{img/maquette/maquette_layout_commun}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\linewidth]{img/maquette/maquette_dashboards}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\linewidth]{img/maquette/maquette_desListes}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\linewidth]{img/maquette/maquette_modifier}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\linewidth]{img/maquette/maquette_disponibilite_desChauffeurs}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.9\linewidth]{img/maquette/maquette_suivi_livraison_endirect}
...
\begin{itemize}[leftmargin=2.5em]
    ...
    \item[$\bullet$] Le RBAC de Fleet~AI est aligné sur le système de rôles WFMS : AD, PL, MG, CH, EC, CL.
