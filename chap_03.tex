...
\begin{figure}[H]
\centering
\includegraphics[width=\linewidth, height=0.40\textheight, keepaspectratio]{img/architecture/backend_architecture}
...
\begin{figure}[H]
\centering
\includegraphics[width=\linewidth, height=0.40\textheight, keepaspectratio]{img/architecture/angular_frontend_architecture}
...
\begin{figure}[H]
\centering
\includegraphics[width=\linewidth, height=0.40\textheight, keepaspectratio]{img/architecture/flutter_mvvm_architecture}
...
La méthodologie Scrum a permis une flexibilité optimale sur les quatre mois du projet. L'architecture N-Tiers associée à la passerelle WFMS offre une structure robuste pour les fonctionnalités décrites dans les chapitres suivants.
