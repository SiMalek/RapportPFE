...
Les story points (SP) sont estimés selon la suite de Fibonacci. L'échelle retenue est : 1--2 (tâche simple), 3--5 (complexité modérée), 8--13 (tâche complexe ou incertaine). Ce sprint, 100\% orienté intelligence artificielle, totalise \textbf{8 stories, 47 SP}.
...
\caption{Sprint Backlog du Sprint 5 --- Prédictions IA \& Chatbot Conversationnel (8 stories, 47 SP)}
\end{longtable}
