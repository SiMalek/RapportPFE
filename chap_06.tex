...
Le Sprint~3 introduit la planification des tournées : affectation manuelle des commandes, création de plans journaliers et récurrents, et gestion des disponibilités des chauffeurs.

\clearpage

\section{Sprint Backlog}

\textbf{Objectif du sprint :} L'affectation manuelle et la planification des tournées sont opérationnelles. Le Planificateur crée des plans journaliers, gère la charge des chauffeurs, définit des règles d'incompatibilité et génère les bons de chargement. Le Chauffeur consulte ses livraisons du jour et son itinéraire depuis l'application mobile. Le suivi GPS en temps réel durant l'exécution terrain sera couvert au Sprint~4.

\input{sprint_backlog_3}
...
\IfFileExists{img/diagrammes/sprint_3_usecase_p2.png}{%
  ...
  \fbox{\parbox{0.9\linewidth}{\centering\vspace{4cm}\textit{[img/diagrammes/sprint\_3\_usecase\_p2.png]}\vspace{4cm}}}%
}
...
\IfFileExists{img/diagrammes/sprint_3_usecase_p3.png}{%
  ...
  \fbox{\parbox{0.9\linewidth}{\centering\vspace{4cm}\textit{[img/diagrammes/sprint\_3\_usecase\_p3.png]}\vspace{4cm}}}%
}
...
\IfFileExists{img/capture/web/sp3_planning_composite.png}{%
  ...
  \fbox{\parbox{0.9\linewidth}{\centering\vspace{4cm}\textit{[img/sp3\_planning\_composite]}\vspace{4cm}}}%
}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.6\linewidth, keepaspectratio]{img/capture/mobile/disponibilite_chauffeur}
...
\IfFileExists{img/capture/web/sp3_plans_composite.png}{%
  ...
  \fbox{\parbox{0.9\linewidth}{\centering\vspace{4cm}\textit{[img/sp3\_plans\_composite]}\vspace{4cm}}}%
}
...
\begin{subfigure}[t]{0.46\linewidth}
  ...
  \IfFileExists{img/capture/mobile/itineraire_flutter.png}{%
    \includegraphics[width=\linewidth, keepaspectratio]{img/capture/mobile/itineraire_flutter.png}%
  }{%
    \fbox{\parbox{0.9\linewidth}{\centering\vspace{3.5cm}\textit{Manque: itineraire\_flutter.png}\vspace{3.5cm}}}%
  }
...
\begin{subfigure}[t]{0.46\linewidth}
  ...
  \IfFileExists{img/capture/mobile/liste_livraisons_flutter.png}{%
    \includegraphics[width=\linewidth, keepaspectratio]{img/capture/mobile/liste_livraisons_flutter.png}%
  }{%
    \fbox{\parbox{0.9\linewidth}{\centering\vspace{3.5cm}\textit{Manque: liste\_livraisons\_flutter.png}\vspace{3.5cm}}}%
  }
...
\begin{figure}[H]
\centering
\IfFileExists{img/capture/web/sp3_test_postman.png}{%
  \includegraphics[width=\linewidth, keepaspectratio]{img/capture/web/sp3_test_postman}%
}{%
  \fbox{\parbox{0.9\linewidth}{\centering\vspace{4cm}\textit{[img/capture/web/sp3\_test\_postman.png]}\vspace{4cm}}}%
}
\caption{Exécution d'un test d'intégration avec Postman pour l'API de création de mission}
\label{fig:sp3-test}
\end{figure}
...
Le Sprint~3 livre le moteur de planification opérationnel de Fleet~AI : affectation manuelle avec contrôle de capacité, gestion des disponibilités des chauffeurs, plans journaliers et récurrents avec génération de bons de chargement. Le suivi GPS et le tableau de bord de pilotage durant l'exécution terrain sont détaillés dans le Sprint~4. Les fonctionnalités d'intelligence artificielle seront déployées dans le Sprint~5.
