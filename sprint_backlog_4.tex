...
Les story points (SP) sont estimés selon la suite de Fibonacci. L'échelle retenue est : 1--2 (tâche simple), 3--5 (complexité modérée), 8--13 (tâche complexe ou incertaine). Ce sprint, centré sur l'exécution terrain, la gestion des paiements, les réclamations et les notifications, totalise \textbf{51 stories, 136 SP}.
...
\caption{Sprint Backlog du Sprint 4 --- Exécution des Livraisons, Paiement \& Réclamations (51 stories, 136 SP)}
\end{longtable}
