...
\IfFileExists{img/diagrammes/sprint_4_usecase_p3.png}{%
  ...
  \fbox{\parbox{0.9\linewidth}{\centering\vspace{1.5cm}\textit{[img/diagrammes/sprint\_4\_usecase\_p3.png]}\vspace{1.5cm}}}%
}
...
\IfFileExists{img/capture/web/sp4_tracking_kpi_composite.png}{%
  ...
  \fbox{\parbox{0.9\linewidth}{\centering\vspace{1.5cm}\textit{[img/sp4\_tracking\_kpi\_composite]}\vspace{1.5cm}}}%
}
...
\IfFileExists{img/capture/web/sp4_payment_composite.png}{%
  ...
  \fbox{\parbox{0.9\linewidth}{\centering\vspace{1.5cm}\textit{[img/sp4\_payment\_composite]}\vspace{1.5cm}}}%
}
...
\IfFileExists{img/capture/web/sp4_reclamations_composite.png}{%
  ...
  \fbox{\parbox{0.9\linewidth}{\centering\vspace{1.5cm}\textit{[img/sp4\_issues\_composite]}\vspace{1.5cm}}}%
}
...
\IfFileExists{img/capture/web/sp4_recap_composite.png}{%
  ...
  \fbox{\parbox{0.9\linewidth}{\centering\vspace{1.5cm}\textit{[img/capture/web/sp4\_recap\_composite.png]}\vspace{1.5cm}}}%
}
...
\begin{figure}[H]
\centering
\includegraphics[width=\linewidth, height=0.38\textheight, keepaspectratio]{img/capture/mobile/support_client}
...
\begin{figure}[H]
\centering
\includegraphics[width=\linewidth, height=0.46\textheight, keepaspectratio]{img/capture/mobile/debut_livraison_chauffeur}
...
\begin{figure}[H]
\centering
\includegraphics[width=\linewidth, height=0.42\textheight, keepaspectratio]{img/capture/mobile/finaliser_livraison_chauffeur}
...
Afin de valider la compatibilité de l'interface web sur les principaux navigateurs du marché, un test de rendu multi-navigateurs a été réalisé sur le tableau de bord administrateur de Fleet~AI. Le même tableau de bord (KPI globaux, graphiques de performance, alertes actives) a été ouvert simultanément sous \textbf{Microsoft Edge}, \textbf{Google Chrome}, \textbf{Brave} et \textbf{Mozilla Firefox}. Le rendu est conforme sur les quatre navigateurs : les métriques (5~197 commandes, 11~053 livraisons, 798 chauffeurs, 1~545~968~DT de chiffre d'affaires), les jauges circulaires et les graphiques de tendance s'affichent de manière identique, confirmant l'absence de régression CSS ou JavaScript entre les moteurs de rendu Blink et Gecko.
...
\IfFileExists{img/capture/web/sp4_test_browser.png}{%
  ...
  \fbox{\parbox{0.9\linewidth}{\centering\vspace{1.5cm}\textit{[img/capture/web/sp4\_test\_browser.png]}\vspace{1.5cm}}}%
}
\caption{Test de compatibilité multi-navigateurs du tableau de bord administrateur (Edge, Chrome, Brave, Firefox)}
\label{fig:sp4-test}
\end{figure}
...
Le Sprint~4 couvre l'exécution terrain de Fleet~AI : suivi GPS temps réel, gestion des trois modes de paiement, traitement des incidents et réclamations avec escalade automatique, et tableaux de bord KPI journaliers. Les fonctionnalités terrain (checklist, confirmation, capture chèque, support client) sont illustrées par les captures de l'application mobile Flutter. Le Sprint~5 introduit la couche prédictive IA.
