...
Les story points (SP) sont estimés selon la suite de Fibonacci. L'échelle retenue est : 1--2 (tâche simple), 3--5 (complexité modérée), 8--13 (tâche complexe ou incertaine). Ce sprint totalise \textbf{27 stories, 89 SP}.
...
\caption{Sprint Backlog du Sprint 2 --- Données Métier, Commandes \& Client Mobile (27 stories, 89 SP)}
\end{longtable}
