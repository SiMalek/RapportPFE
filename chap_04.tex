...
Le Sprint~1 met en place l'infrastructure fondatrice de Fleet~AI : authentification WFMS, référentiels utilisateurs, véhicules, chauffeurs et zones, tableau de bord, journal d'audit, sauvegardes et l'application mobile chauffeur.

\clearpage

\section{Sprint Backlog}

\textbf{Objectif du sprint :} L'authentification unifiée WFMS est opérationnelle sur web et mobile. L'Administrateur gère les utilisateurs avec contrôle d'accès par rôles, les véhicules, les zones géographiques, les logs d'audit et les sauvegardes. Le Planificateur consulte les ressources disponibles. Le Manager suit les coûts et l'utilisation. Le Chauffeur accède à son profil, ses métriques et déclare sa disponibilité depuis l'application mobile.
