...
\IfFileExists{img/capture/web/sp1_dashboard_composite.png}{%
  ...
  \fbox{\parbox{0.9\linewidth}{\centering\vspace{1.5cm}\textit{[img/sp1\_dashboard\_composite]}\vspace{1.5cm}}}%
}
...
\IfFileExists{img/capture/web/sp1_users_composite.png}{%
  ...
  \fbox{\parbox{0.9\linewidth}{\centering\vspace{1.5cm}\textit{[img/sp1\_users\_composite]}\vspace{1.5cm}}}%
}
...
\IfFileExists{img/capture/web/sp1_vehicles_composite.png}{%
  ...
  \fbox{\parbox{0.9\linewidth}{\centering\vspace{1.5cm}\textit{[img/sp1\_vehicles\_composite]}\vspace{1.5cm}}}%
}
...
\IfFileExists{img/capture/web/sp1_drivers_composite.png}{%
  ...
  \fbox{\parbox{0.9\linewidth}{\centering\vspace{1.5cm}\textit{[img/sp1\_drivers\_composite]}\vspace{1.5cm}}}%
}
...
\IfFileExists{img/capture/web/sp1_zones_composite.png}{%
  ...
  \fbox{\parbox{0.9\linewidth}{\centering\vspace{1.5cm}\textit{[img/sp1\_zones\_composite]}\vspace{1.5cm}}}%
}
...
\IfFileExists{img/capture/web/sp1_audit_composite.png}{%
  ...
  \fbox{\parbox{0.9\linewidth}{\centering\vspace{1.5cm}\textit{[img/sp1\_audit\_composite]}\vspace{1.5cm}}}%
}
...
\IfFileExists{img/capture/web/sp1_notifications_composite.png}{%
  ...
  \fbox{\parbox{0.9\linewidth}{\centering\vspace{1.5cm}\textit{[img/sp1\_notifications\_composite]}\vspace{1.5cm}}}%
}
...
\IfFileExists{img/capture/web/sp1_test_junit.png}{%
  ...
  \fbox{\parbox{0.9\linewidth}{\centering\vspace{1.5cm}\textit{[img/capture/web/sp1\_test\_junit.png]}\vspace{1.5cm}}}%
}
\caption{Exemple d'un test unitaire JUnit (Sprint~1)}
\label{fig:sp1-test}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=\linewidth, height=0.32\textheight, keepaspectratio]{img/capture/web/sp1_resultat_test_junit}
\caption{Résultats d'exécution des tests unitaires JUnit --- Sprint~1 (Succès)}
\label{fig:sp1-test-result}
\end{figure}

\section*{Conclusion}
\addcontentsline{toc}{section}{Conclusion}

Le Sprint~1 livre les fondations de Fleet~AI : authentification unifiée via WFMS, contrôle d'accès par rôles, gestion des référentiels opérationnels (utilisateurs, véhicules, chauffeurs, zones) et journal d'audit avec double persistance. L'application mobile Flutter permet au Chauffeur de consulter ses indicateurs et de déclarer sa disponibilité. Ces composants constituent la base des sprints suivants.
