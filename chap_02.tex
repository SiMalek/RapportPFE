...
\begin{itemize}
  ...
  \item[$\bullet$] \textbf{Contrôle d'accès inadapté :} Les systèmes de permissions ne correspondent pas à la hiérarchie spécifique requise par PGH (Administrateur, Planificateur, Manager, Chauffeur, Responsable Engagement Client, Client).
